  ...
  return (
    <>
      <div className="fixed inset-0 bg-black text-white flex flex-col justify-center items-center z-50">
        {!connected ? (
          <>
            <p className="text-lg mb-2">📞 Incoming Call</p>
            ...
            <div className="flex gap-12">
              ...
              <button onClick={onClose} className="bg-red-500 p-5 rounded-full">
                <PhoneOff size={32} />
              </button>
            </div>
          </>
          ...
          <>
            ...
            <h1 className="text-4xl font-bold mb-4">{caller}</h1>

            <p className="text-2xl mb-10">{formatTime()}</p>
